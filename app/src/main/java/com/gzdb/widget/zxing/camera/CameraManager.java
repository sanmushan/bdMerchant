...
package com.gzdb.widget.zxing.camera;
...
public final class CameraManager {
  ...
  /**
   * Initializes this static object with the Context of the calling FAQActivity.
   *
   * @param context The FAQActivity which wants to use the camera.
   */
