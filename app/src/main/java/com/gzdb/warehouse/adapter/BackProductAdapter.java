...
public class BackProductAdapter extends AfinalAdapter<AdapterModel> implements NumInputView.NumInputListener {
    ...
    public BackProductAdapter(Context context, List<AdapterModel> supplyItems, boolean isCart) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BackWareShopCart.CartItem cartItem = null;
        SupplyItem item = null;

        if (model.getUiType() == CART_MODEL_UI_TYPE_ITEM) {
            //模型来源于 采购页面
            item = (SupplyItem) model;
            cartItem = BackWareShopCart.getCartItem(item.getItemId());
        } else {
            //模型来源于 购物车
            cartItem = (BackWareShopCart.CartItem) model;
    ...
    public boolean onClickNum(String text) {
        ...
        try {
            ...
            if (click_holder.cartItem == null) {
                click_holder.cartItem = BackWareShopCart.createCartItem(click_holder.item);
            }
            //检测 库存
    ...
    class Holder implements View.OnClickListener {
        ...
        int position;
        SupplyItem item;
        BackWareShopCart.CartItem cartItem;
        ...
        void add() {
            ...
            if (cartItem == null) {
                cartItem = BackWareShopCart.createCartItem(item);
            }
