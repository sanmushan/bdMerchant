 ...
 */
public class WareShopCart {

    private static Map<Long, CartItem> itemMaps = new HashMap<Long, WareShopCart.CartItem>();
    public static final List<CartItem> itemLists = new ArrayList<WareShopCart.CartItem>();
