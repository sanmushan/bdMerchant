...
public class ZWarehouseOrderFragment extends AfinalFragment implements View.OnClickListener {
...
//        title_center_txt1.setOnClickListener(this);
        ...
        scanCallback = new ScanActivity.ScanCallback() {
            ...
            public void onScanSuccess(String code) {
                ...
                map.put("qrCode", code);
                Http.post(ZWarehouseOrderFragment.this.getActivity(), map, Api.SCAN_QRCODE, new HttpCallback<OrderDetail>() {
                    @Override
                    public void onSuccess(OrderDetail data) {
                        //跳去详情
                        Intent intent = new Intent(ZWarehouseOrderFragment.this.getActivity(), OrderDetailActivity.class);
                        ...
                        ZWarehouseOrderFragment.this.getActivity().startActivity(intent);
                    }
                });
            }
        };
    ...
    void setOrderType(OrderTypeEnum orderType) {
        ...
        for (int i = 0; i < fragments.size(); i++) {
            ...
            if (orderType != OrderTypeEnum.ALLOCATION_ORDER_TYPE) {
                f.setNewOrderRoleTypeEnum(OrderRoleTypeEnum.CONSUMER);
            }else {
                f.setNewOrderRoleTypeEnum(OrderRoleTypeEnum.MERCHANT);
            }
        }
...
//        } else
        if (id == R.id.title_center_txt2) {
            ...
            intent.setClass(this.getActivity(), ScanActivity.class);
