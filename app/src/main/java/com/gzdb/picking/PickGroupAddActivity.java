...
import com.gzdb.developing.TypeActivity;
...
public class PickGroupAddActivity extends AfinalActivity implements View.OnClickListener ,ScrollerListView.IXListViewListener{
    ...
    public int getContentViewId() {
        return R.layout.activity_pick_group_add;
    }
    ...
    public void initView(View view) {
        try {
            ...
            adapter = new TypeAdapter(PickGroupAddActivity.this, list);
            lv_type.setAdapter(adapter);
            typeChildAdapter = new TypeChildAdapter(PickGroupAddActivity.this, child_list);
    ...
    public void  submit(){
        ...
        if(edit_group_input.getText().toString().length()==0){
            ToastUtil.showToast(PickGroupAddActivity.this,"组名不能为空!");
            return;
        }
        ...
        httpPost(map, Api.BasesupplychainRemoteURL() +"warehouse/addGroup", new HttpCallback() {
            @Override
            ...
            public void onFailure() {
                super.onFailure();
                ToastUtil.showToast(PickGroupAddActivity.this,msg);
            }
        });
    }
    @Override
