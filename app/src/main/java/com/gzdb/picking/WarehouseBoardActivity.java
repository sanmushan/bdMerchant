...
/**
 * Created by liyunbiao on 2017/9/5.
 */

public class WarehouseBoardActivity  extends AfinalActivity implements View.OnClickListener {
    //选中的itemTypeId
    ...
    public int getContentViewId() {
        return R.layout.activity_warehouse_board;
    }
    ...
    public void initView(View view) {
        ...
        adapter = new ProductAdpater(WarehouseBoardActivity.this, items);
        ...
        refreshLoad = new RefreshLoad(WarehouseBoardActivity.this, ptr, view, new RefreshLoadListener() {
            @Override
