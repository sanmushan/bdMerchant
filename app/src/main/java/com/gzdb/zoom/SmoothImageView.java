...
//		setBackgroundColor(mBgColor);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {
			...
			if(mTransformStart){
				Log.d("warehouse", "mTransfrom.startScale:"+mTransfrom.startScale);
				Log.d("warehouse", "mTransfrom.startScale:"+mTransfrom.endScale);
				Log.d("warehouse", "mTransfrom.scale:"+mTransfrom.scale);
				Log.d("warehouse", "mTransfrom.startRect:"+mTransfrom.startRect.toString());
				Log.d("warehouse", "mTransfrom.endRect:"+mTransfrom.endRect.toString());
				Log.d("warehouse", "mTransfrom.rect:"+mTransfrom.rect.toString());
			}
